...
- [x] Layer 7 Distributed Systems — RPC + a deterministic, seeded, in-process network simulator with real fault injection (drop/duplicate/reorder/delay, hard partitions with heal), 35 hosted tests including a genuine determinism proof; no real transport, membership, or Raft yet (see [ADR 0008](docs/ADR/0008-distributed-rpc.md))
