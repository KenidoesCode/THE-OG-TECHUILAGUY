...
current commit (32 suites, 783 assertions, 0 failures). See
...
| DHCP/DNS/TCP/UDP behavior, multi-hop routing, VLANs/NAT/firewalls, latency/loss/bandwidth simulation, visual topology editor, WebAssembly build, browser UI, additional missions/grading/XP/skill tree/classroom mode, multiplayer, save/load, AI tutor | PLANNED | none of these exist yet |
